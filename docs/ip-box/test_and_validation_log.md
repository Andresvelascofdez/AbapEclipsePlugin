...
- Reviewer/validator: local automated validation executed in the development environment; owner manual validation TODO/TBC.
...
- Status: TODO/TBC.
- Follow-up required: project owner or a local development environment with Eclipse runtime should record results.
...
- Reviewer/validator: local automated validation executed in the development environment; Eclipse workspace validation by owner TODO/TBC.
...
- Reviewer/validator: local automated validation using Eclipse and the owner's local `.env`.
...
- Reviewer/validator: local automated validation; owner UI validation TODO/TBC.
...
- Reviewer/validator: local automated validation; owner manual UI validation TODO/TBC.
