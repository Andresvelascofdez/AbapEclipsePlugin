...
| Dependency summary panel screenshot | TODO/TBC | To be captured manually | Capture the read-only dependency/context summary panel using anonymised or non-confidential ABAP code. |
